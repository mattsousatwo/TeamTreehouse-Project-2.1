...
class ViewController: UIViewController {
 ...
 /*    MARCH 11th 
    ...
    func pickQuestion() -> String {
        let chosenQuestion = trivia.randomFact()
        return chosenQuestion
    }
    

     func displayAQuestion() {
            let displayQuestion = pickQuestion()
 ...
 */
    ...
    // for question in shownQuestions {
    //  if pulledQuestion == question {
    //  questionField.text = trivia.randomFact()
    // } else if pulledQuestion != question{
    // questionfeild.text = pulledQuestion
    ...
    func checkQuestions() {
        let chosenQuestion = questionField.text
        for question in shownQuestion {
            if chosenQuestion == question {
                displayQuestion()
            } else if chosenQuestion != question {
                questionField.text = question                   // error usually occurs here
            }
